...
def stream_chat_response(prompt):
    ...
    curl_command = [
        "curl",
        "-X", "POST", "https://aethir.gaianet.network/v1/chat/completions",
        "-H", "accept: application/json",
        "-H", "Content-Type: application/json",
        "-d", json.dumps({
            "messages": [
                {"role": "system", "content": "You are awesome blockchain developer, you tries to blockchain development with good practices"},
